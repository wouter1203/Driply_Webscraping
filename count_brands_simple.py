#!/usr/bin/env python3
"""
Simple script to count brands in the brand_field of a Firestore collection
Usage: python count_brands_simple.py <collection_name>
"""
...
def count_brands_in_collection(collection_name):
    ...
    try:
        ...
        for doc in docs:
            ...
            # Check if brand_name field exists and has a value
...
def main():
    ...
    if len(sys.argv) != 2:
        print("Usage: python count_brands_simple.py <collection_name>")
        print("Example: python count_brands_simple.py products")
        sys.exit(1)
